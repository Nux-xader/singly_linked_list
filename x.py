...
def add_dvd():
    ...
    DVDstock.append(dvdtype.dvdType(titlenew, star1new, star2new, producernew, directornew, prodcomnew, nonew))
...
def add_customer():
    ...
    CustomerList.append(customertype.customerType(firstname, lastname, accNo, []))


def list_all_dvd_details():
    global DVDstock
    [print(f'\n{std}') for std in DVDstock]
    print('')
...
def list_all_titles():
    global DVDstock
    print('')
    [print(f'Title : {std.get_title()}') for std in DVDstock]
    print('')
